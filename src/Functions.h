...
string asmInitializeVariables = R"(
	; Get LoadLibraryA
	push hLoadLibraryA
	call ebp
...
string asmTLSCallback = R"(
	push esi
	lea esi, ds:[ebx+AddressOfCallBacks]
	cld
	label_get:
	lodsd
	test eax, eax
